" Vim color file
" Converted from Textmate theme Calydon plain using Coloration v0.3.3 (http://github.com/sickill/coloration)
...
let g:colors_name = "Calydon plain"
...
hi Boolean ctermfg=134 ctermbg=NONE cterm=NONE guifg=#c332cd guibg=NONE gui=NONE
hi Character ctermfg=64 ctermbg=NONE cterm=NONE guifg=#41812f guibg=NONE gui=NONE
hi Comment ctermfg=242 ctermbg=NONE cterm=NONE guifg=#6d6d6d guibg=NONE gui=italic
hi Conditional ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
hi Constant ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi Define ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
...
hi Float ctermfg=166 ctermbg=NONE cterm=NONE guifg=#cd3228 guibg=NONE gui=NONE
hi Function ctermfg=167 ctermbg=NONE cterm=NONE guifg=#cd4e55 guibg=NONE gui=NONE
hi Identifier ctermfg=38 ctermbg=NONE cterm=NONE guifg=#1ba6c4 guibg=NONE gui=NONE
hi Keyword ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
hi Label ctermfg=149 ctermbg=NONE cterm=NONE guifg=#a8cd3a guibg=NONE gui=NONE
hi NonText ctermfg=235 ctermbg=235 cterm=NONE guifg=#262626 guibg=#272727 gui=NONE
hi Number ctermfg=166 ctermbg=NONE cterm=NONE guifg=#cd3228 guibg=NONE gui=NONE
hi Operator ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
hi PreProc ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
...
hi Statement ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
hi StorageClass ctermfg=38 ctermbg=NONE cterm=NONE guifg=#1ba6c4 guibg=NONE gui=NONE
hi String ctermfg=149 ctermbg=NONE cterm=NONE guifg=#a8cd3a guibg=NONE gui=NONE
...
hi Todo ctermfg=242 ctermbg=NONE cterm=inverse,bold guifg=#6d6d6d guibg=NONE gui=inverse,bold,italic
hi Type ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi Underlined ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi rubyClass ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
hi rubyFunction ctermfg=167 ctermbg=NONE cterm=NONE guifg=#cd4e55 guibg=NONE gui=NONE
hi rubyInterpolationDelimiter ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi rubySymbol ctermfg=64 ctermbg=NONE cterm=NONE guifg=#41812f guibg=NONE gui=NONE
hi rubyConstant ctermfg=104 ctermbg=NONE cterm=NONE guifg=#917ccd guibg=NONE gui=NONE
hi rubyStringDelimiter ctermfg=149 ctermbg=NONE cterm=NONE guifg=#a8cd3a guibg=NONE gui=NONE
hi rubyBlockParameter ctermfg=77 ctermbg=NONE cterm=NONE guifg=#58cd4d guibg=NONE gui=NONE
hi rubyInstanceVariable ctermfg=71 ctermbg=NONE cterm=NONE guifg=#57b646 guibg=NONE gui=NONE
hi rubyInclude ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
hi rubyGlobalVariable ctermfg=71 ctermbg=NONE cterm=NONE guifg=#57b646 guibg=NONE gui=NONE
hi rubyRegexp ctermfg=149 ctermbg=NONE cterm=NONE guifg=#a8cd3a guibg=NONE gui=NONE
hi rubyRegexpDelimiter ctermfg=149 ctermbg=NONE cterm=NONE guifg=#a8cd3a guibg=NONE gui=NONE
hi rubyEscape ctermfg=64 ctermbg=NONE cterm=NONE guifg=#41812f guibg=NONE gui=NONE
hi rubyControl ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
hi rubyClassVariable ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi rubyOperator ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
hi rubyException ctermfg=68 ctermbg=NONE cterm=NONE guifg=#5874cd guibg=NONE gui=NONE
hi rubyPseudoVariable ctermfg=71 ctermbg=NONE cterm=NONE guifg=#57b646 guibg=NONE gui=NONE
hi rubyRailsUserClass ctermfg=104 ctermbg=NONE cterm=NONE guifg=#917ccd guibg=NONE gui=NONE
...
hi erubyComment ctermfg=242 ctermbg=NONE cterm=NONE guifg=#6d6d6d guibg=NONE gui=italic
...
hi javaScriptFunction ctermfg=38 ctermbg=NONE cterm=NONE guifg=#1ba6c4 guibg=NONE gui=NONE
...
hi yamlAnchor ctermfg=71 ctermbg=NONE cterm=NONE guifg=#57b646 guibg=NONE gui=NONE
hi yamlAlias ctermfg=71 ctermbg=NONE cterm=NONE guifg=#57b646 guibg=NONE gui=NONE
hi yamlDocumentHeader ctermfg=149 ctermbg=NONE cterm=NONE guifg=#a8cd3a guibg=NONE gui=NONE
hi cssURL ctermfg=77 ctermbg=NONE cterm=NONE guifg=#58cd4d guibg=NONE gui=NONE
...
hi cssValueLength ctermfg=166 ctermbg=NONE cterm=NONE guifg=#cd3228 guibg=NONE gui=NONE
hi cssCommonAttr ctermfg=175 ctermbg=NONE cterm=NONE guifg=#cd8db4 guibg=NONE gui=NONE
